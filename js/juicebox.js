...
var juicebox_config_manager = function(c, x) {
    ...
    var u = "048d7e421a20974d54391bc3463ebd52";
    var B = function(T, S) {
        switch (S) {
            case "boolean":
                if (typeof T == "boolean") {
...
var juicebox_sizing_manager = function(g, N, p) {
    ...
    var i = function(ap) {
        ...
        if (((s && !K(ap, ap.gallerywidth, ap.galleryheight)) || c(ap)) && !(ao.is_iphone() && j(ap))) {
            return false
        }
        return true
    };
    ...
    var K = function(aq, ar, ap) {
        if (ao.isEmbeddedMode(M("#" + aq.containerid))) {
            return false
        }
        if (ar === "100%" && ap === "100%") {
            return true
    ...
    var j = function(ap) {
        if (K(ap, ap.gallerywidth, ap.galleryheight)) {
            return true
        }
        return false
    };
    ...
    var T = function(aD, aC, aJ, aq, aA) {
        ...
        if (au === "TOP") {
            ...
            if (au === "BOTTOM") {
                at = (aH === "BOTTOM" ? av : 0) + parseInt((aC - aI) - (ao.is_side_layout(aJ) ? aJ.thumbpadding : 0) / 2 + aJ.thumbpadding / 2) - (aG === "BOTTOM" ? aE + B(aJ) : 0)
            } else {
        ...
        var after_loading_images = function() {
            ...
            if (context.features.fullscreen.switched_2_fullscreen()) {
                ...
                context.utils.add_fullscreen_listener(function(fullscreen) {
                    if (context.utils.is_ie_edge()) {
                        if (context.utils.is_in_real_fullscreen()) {
...
juicebox_registered_components.buttonbar = function() {
    ...
    var x = function() {
        ...
        var y = "",
            A = "display:none;";
        if (z != "TOP" && !o.config.showinfobutton) {
    ...
    var n = function() {
        ...
        return h("jb-bb-btn-de-show-list", o.config.languagelistall.st, o.utils.is_large_screen_mode(o.config) ? "&#xe002;" : "&#xe003;") + h("jb-bb-btn-open-url", o.config.languagelistall.oiinw, "&#xe004;") + (o.config.showdownloadbutton ? h("jb-bb-btn-download", o.config.languagelistall.download, "D") : "") + h("jb-bb-btn-full-screen" + ((y.is_full_screen || o.utils.is_new_expanded_window()) ? " jb-bb-btn-de-full-screen" : ""), ((y.is_full_screen || o.utils.is_new_expanded_window()) ? o.config.languagelistall.ef : o.config.languagelistall.gf), (y.is_full_screen || o.utils.is_new_expanded_window()) ? "&#xe006;" : "&#xe005;")
    };
    var i = function() {
    ...
    var p = function() {
        return h("jb-bb-btn-fotomoto", o.config.languagelistall.fotomoto, "&#xe00e;", o.config.fotomotostoreid ? false : true) + (o.config.sharefacebook ? h("jb-bb-btn-facebook", o.config.languagelistall.facebook, "&#xe00f;") : "") + (o.config.sharetwitter ? h("jb-bb-btn-twitter", o.config.languagelistall.twitter, "&#xe010;") : "") + (o.config.sharegplus ? h("jb-bb-btn-gplus", o.config.languagelistall.gplus, "&#xe011;") : "") + (o.config.sharepinterest ? h("jb-bb-btn-printerest", o.config.languagelistall.printerest, "&#xe012;") : "") + (o.config.sharetumblr ? h("jb-bb-btn-tumblr", o.config.languagelistall.tumblr, "&#xe013;") : "") + (o.config.showemailbutton ? h("jb-bb-btn-email", o.config.languagelistall.email, "M") : "")
    };
    ...
    var e = function() {
        ...
        o.utils.setup_components_event(o.features, "showthumbsbutton,openurl,download,fullscreen,topnavleft,autoplay,topnavright,showinfo,audio,fotomoto,facebook,twitter,gplus,printerest,tumblr,email");
    ...
    var v = function() {
        ...
        if (o.config.showimageoverlay.toUpperCase() === "NEVER" || (o.config.showimageoverlay.toUpperCase() !== "ALWAYS" && !o.isOverlayVisible())) {
            w(".jb-bb-bar").hide()
        }
    };
    var d = function(A) {
        ...
        if (!o.config.showdownloadbutton) {
            w(".jb-bb-btn-download").hide()
        } else {
            J = true;
            G = true;
            I++
        ...
        if (!o.features.fotomoto.isVisible()) {
            if (!A) {
                var F = w(".jb-bb-btn-fotomoto").is(":visible");
        ...
        if (!o.config.showemailbutton) {
            w(".jb-bb-btn-email").hide()
        } else {
            J = true;
            E = true;
            I++
        ...
        var H = o.config.showimageoverlay.toUpperCase();
        var y = o.config.buttonbarposition.toUpperCase();
        var B = ".jb-classifier-link-wrapper.jb-classifier-detail-area";
        if (y === "NONE") {
            w(B + ", .jb-classifier-link-wrapper.jb-classifier-thumb-area").remove()
        } else {
            if (o.config.showinfobutton || o.isOverlayVisible() || y === "TOP" || H === "ALWAYS") {
    ...
    var j = function() {
        ...
        if (o.config.showexpandbutton && o.config.originalshowexpandbutton && (!o.isFullScreenMode() || o.features.fullscreen.switched_2_fullscreen() || o.utils.is_new_expanded_window()) && (!o.utils.is_in_iframe())) {
            return true
        }
        return false
    };
    ...
    var b = function() {
        ...
        if (B != "OVERLAY_IMAGE" && B != "NONE") {
            ...
            var F = 0;
            var H = (B == o.config.backbuttonposition.toUpperCase()) || (!o.utils.is_large_screen_mode(o.config) && o.config.showsmallbackbutton);
            if (o.detail_panel.is_visible() && o.features.backbutton.isNeeded() && H) {
                var I = o.config.backbuttonhalign.toUpperCase();
                if ((I === "LEFT" && E == "RIGHT") || (I === "RIGHT" && E == "LEFT")) {
                    F = g(".jb-go-back").width() + 55
                }
            }
            var G = false;
            var J = o.glrySizePosition();
            var K = 10;
            var A = o.glryStagPadding();
            var D = A;
            C = l();
            if (E === "CENTER") {
                G = true;
                D = parseInt((o.glryWidth() - C) / 2) - 10
            } else {
                if (E === "LEFT") {
                    G = true
                }
            }
            var y = K + J.detail_panel_top;
            if (B === "TOP") {
                y = K - 4 + J.top_panel_top
            }
            var L = o.utils.get_button_bar_button_size(o.config);
            if (C > o.glryWidth() - 2 * o.config.stagepadding - F - 20) {
                C = o.glryWidth() - 2 * o.config.stagepadding - F
            }
            var z = L.buttonWidth;
            var C = parseInt((C - 0) / z) * z + parseInt(z / 1.7 + (z > 25 && z < 40 ? 8 : 0));
            if (G) {
...
juicebox_registered_components.fullscreen = function() {
    ...
    var m = function() {
        if (!e.is_full_screen) {
            ...
            var r = a.utils.get_viewport_meta_content();
            a.utils.set_viewport_meta(a.config, true);
            var u = d.extend({}, a.config);
            ...
            u.containerid = h.get_id();
            u.parent_gallery = juicebox_instances[a.instance_id];
            u.gallerywidth = "100%";
            u.galleryheight = "100%";
            u.fullscreen_displaying_mode = true;
            u.parent_gallery = juicebox_instances[a.instance_id];
            u.initial_html_css_inline_style = d("html").attr("style");
            u.scroll_position = {};
            u.scroll_position.scrollTop = d(window).scrollTop();
            u.scroll_position.scrollLeft = d(window).scrollLeft();
            window.scroll(0, 0);
            u.persistor_param = {};
            u.persistor_param.image_orders = a.gallery_manager().get_image_orders();
            u.persistor_param.viewportContent = r;
            var D = d(window);
            var C = a.utils.is_large_screen_mode(a.config);
            u.persistor_param.max_side_length = Math.max(D.width(), D.height());
            u.persistor_param.restore_viewport = function(J, I) {
                a.utils.set_viewport_value(J, I)
            };
            var o = a.config.showsmallthumbsonload && !a.utils.is_large_screen_mode(a.config) ? true : false;
            u.persistor_param.is_index_visible = a.features.splash.isSet() ? o : a.index_panel.is_visible();
            u.persistor_param.is_detail_visible = a.features.splash.isSet() ? !o : a.detail_panel.is_visible();
            u.persistor_param.current_image_index = a.detail_panel.get_photo_position();
            u.persistor_param.restore_image = function(I) {
            ...
            u.persistor_param.restore_index = (C ? a.redrawIndexPanel : a.features.showthumbsbutton.switch2Thumbnails);
            u.persistor_param.splash_is_set = a.features.splash.isSet();
            u.persistor_param.background_image_width = a.features.backgroundimage.getSizingInfo().width;
            u.persistor_param.background_image_height = a.features.backgroundimage.getSizingInfo().height;
            u.persistor_param.gallery_manager = a.gallery_manager;
            u.persistor_param.hide_thumbnails_in_lsm = a.features.showthumbsbutton.isThumbsHidden();
            u.persistor_param.last_image_event_index = (a.detail_panel.get_current_photo() ? a.detail_panel.get_current_photo().position : 0) + 1;
            u.persistor_param.overlay_info_visible = a.config.showinfobutton ? a.features.showinfo.visible() : a.isOverlayVisible();
            u.persistor_param.openedFromSplash = a.features.splash.opendFromSplash;
            if (a.features.audio.isNeeded()) {
                u.persistor_param.is_audio_playing = a.features.audio.isPlaying();
                u.persistor_param.parent_toggle_audio_play = a.features.audio.toggleAudioPlay;
                u.persistor_param.need2PlayAudioAfterSplash = a.features.splash.need2PlayAudioAfterSplash;
                u.persistor_param.stopAudioPlay = a.features.audio.stop
            }
            u.persistor_param.parent_set_info_visible = a.features.showinfo.showInfoCtrls;
            u.persistor_param.different_size_images_in_config = a.hasMultipleSizeImages;
            var s = a.features.autoplay.isPlaying();
            a.features.autoplay.stop(false, true);
            u.persistor_param.is_autoplaying = s;
            u.persistor_param.restore_autoplay = function(I) {
            ...
            d("html").css(F);
            d("body").addClass("jb-flag-fullscreen");
            var y = C ? false : true;
            if (a.config.backgroundopacity === 1 || a.config.backgroundopacity === "1" || (typeof(a.config.backgroundopacity) === "string" && a.config.backgroundopacity.indexOf("filter") === 0 && a.config.backgroundopacity.indexOf("100") > 0)) {
                ...
                u.persistor_param.restore_zindex = function() {
                    n("").show();
                    n("").focus()
                };
                n("").hide()
            }
            var w = a.config.expandedbackgroundcoloropacity >= 1 ? true : false;
            var G = 1000 * a.config.dialogfadetime;
            h.fadein_dialog(w, G, function() {
                a.setExtendedGlry(new juicebox(u))
            });
            ...
            if (a.utils.need_viewport_meta(a.config)) {
                ...
                var v = e.parent_gallery_param.viewportContent ? e.parent_gallery_param.viewportContent : "";
                a.utils.set_viewport_meta_content(v)
            }
            if (!e.parent_gallery_param.splash_is_set) {
                e.parent_gallery_param.parent_set_info_visible(a.features.showinfo.visible());
                var x = a.detail_panel.get_photo_position();
                if (a.detail_panel.is_visible()) {
                    e.parent_gallery_param.restore_image(x)
                }
                if (a.index_panel.is_visible()) {
                    e.parent_gallery_param.restore_index(x)
                }
            }
            window.setTimeout(function() {
                d("html").css({
                ...
                window.setTimeout(function() {
                    ...
                    d("body").removeClass("jb-flag-fullscreen");
            ...
            var p = a.features.autoplay.isPlaying();
            if (a.features.fullscreen.switched_2_fullscreen()) {
                if (a.features.fullscreen.getPersistor().parent_gallery_param.openedFromSplash()) {
                    ...
                    p = a.config.autoplayonload ? true : false
                }
            }
            e.parent_gallery_param.restore_autoplay(p);
            a.features.hashstatus.enableHashEvent(false);
...
juicebox_registered_components.autoplay = function() {
    ...
    var d = function(w) {
        ...
        if (a.config.showautoplaystatus && !w) {
            ...
            var s = r.detail_panel_width / 2 - 60;
            v.css({
                top: u,
                left: s,
                width: "115px"
...
juicebox_registered_components.email = function() {
    ...
    var b = function() {
        if (a.config.emailaddress) {
            ...
            var g = "Regarding image #" + (h.imagePosition + 1) + (i ? ': "' + encodeURIComponent(i) + '"' : "") + (a.config.gallerytitle ? ' in gallery "' + j + '"' : "") + " (" + h.shareUrl + ").";
...
juicebox_registered_components.login = function() {
    ...
    var d = function(k, n, m) {
        ...
        var l = "<div style='width:100%;height:100%;text-align:center;'><div id='jb-dialog-login-form' class='jb-dialog-login-form-text'><div id='jb-dialog-login-form-prompt' class='jb-dialog-login-form-text'></div><div class='jb-dialog-input-area jb-dialog-login-form-text'><input id='jb-dialog-login-text' type='password' name='pssword' maxlength='45' placeholder='Password'/><input id='jb-dialog-btn-login-submit' class='jb-dialog-login-form-text' type='submit' value='OK'/></div><div class='jb-login-error-message'>Incorrect Password.</div><div id='jb-dialog-login-form-prompt-message' class='jb-dialog-login-form-text'>To request a new password, send email</div></div></div>";
        var j = function(p) {
